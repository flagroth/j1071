...
public:
	...
	void Solve(int l, const QMatrix& Q, const double *p_, const schar *y_,
		   ...
		   SolutionInfo* si, int shrinking, int iter_arg);
protected:
	int active_size;
	schar *y;
...
public:
	...
	{
		this->si = si;
		Solver::Solve(l,Q,p,y,alpha,Cp,Cn,eps,si,shrinking,iter_arg);
	}
private:
	SolutionInfo *si;
	...
	double *alpha, Solver::SolutionInfo* si, double Cp, double Cn)
{
	...
	s.Solve(l, SVC_Q(*prob,*param,y), minus_ones, y,
		alpha, Cp, Cn, param->eps, si, param->shrinking, param->iter);
	...
	double *alpha, Solver::SolutionInfo* si)
{
	...
	s.Solve(l, SVC_Q(*prob,*param,y), zeros, y,
		alpha, 1.0, 1.0, param->eps, si,  param->shrinking, param->iter);
	double r = si->r;
	...
	double *alpha, Solver::SolutionInfo* si)
{
	...
	s.Solve(2*l, SVR_Q(*prob,*param), linear_term, y,
		alpha2, param->C, param->C, param->eps, si, param->shrinking, param->iter);
	...
	double *alpha, Solver::SolutionInfo* si)
{
	...
	Solver_NU s;
	s.Solve(2*l, SVR_Q(*prob,*param), linear_term, y,
		alpha2, C, C, param->eps, si, param->shrinking, param->iter);
